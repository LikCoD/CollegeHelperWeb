...
@Component({
  selector: "app-base-journal-row-month-section",
  templateUrl: "./base-journal-row-month-section.component.html",
  styleUrls: ["./base-journal-row-month-section.component.scss"],
})
export class BaseJournalRowMonthSectionComponent implements OnInit {
  ...
  get collapsed(): boolean {
    return this.service.pointCollapseType(this.cells[0][0].point) === "month"
  }
  ...
  expand(): void {
    this.service.click(this.cells[0][0].point)
  }
